...
import CurrentWeather, { currentWeatherType } from './components/search/current-weather/current-weather';
...
function App() {
  ...
  const handleOnSearchChange = (searchData: searchDataItem) => {
    ...
    const currentForecast = fetch(`${WEATHER_API_URL}/forecast?lat=${latitude}&lon=${longitude}&appid=${WEATHER_API_KEY}`);
